...
IF(kptn LIKE ''%bpm%'',''BillspaySendout'',
 ...
 kptn, CONVERT(AES_DECRYPT(principal,''mlinc1234''), DECIMAL(11,2)) as principal,
 CONVERT(AES_DECRYPT(charge,''mlinc1234''), DECIMAL(11,2)) as  charge, 
 CONVERT(AES_DECRYPT(runningbalance,''mlinc1234''), DECIMAL(11,2)) AS balance
